...
export default function TopicHero() {
  return (
    <div className="bg-gradient-to-l from-indigo-600 via-violet-600 to-purple-700 rounded-3xl p-5 sm:p-7 text-white shadow-xl shadow-indigo-100">
      <div className="flex items-start gap-4 sm:gap-5">
        ...
        <div>
          ...
          <h1 className="text-xl sm:text-2xl font-black mb-2">{TOPIC.title}</h1>
